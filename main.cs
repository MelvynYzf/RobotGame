...
namespace RobotGame
{
    public partial class main : Form
    {
        ...
        private void endGames()
        {
            ...
            pvBar = 0;
            MainPlayer.Location = new Point((this.ClientSize.Width / 2) - (MainPlayer.Width / 2), 522); ;
            MainPlayer.Image = Properties.Resources.tombstone;

            playerStatusChecker.Stop();
            moneyTimer.Stop();
            FragCounter2.Visible = true;
        ...
        private void FragCounter2_Click(object sender, EventArgs e)
        {

        }

        private void bombe_Click(object sender, EventArgs e)
        {

        }

        private void helpp_Click(object sender, EventArgs e)
        {
